        ...
        <div class="form-container">
            ...
            <div class="exchange-container">
                ...
                <div class="exchange-box">
                    <div class="exchange-title">Обмен кристаллов на золото</div>
                    <div class="exchange-rate">Курс: 1 кристалл = 10 золота</div>
                    <form class="exchange-form" method="POST">
                        <input type="number" name="crystals" min="1" max="<?= $crystals ?>" 
                               placeholder="Количество кристаллов" required>
                        <button  type="submit" name="exchange_crystals">Обменять</button>
                    </form>
                </div>
                
                <!-- Покупка золота за рубли -->
                <div class="exchange-box">
                    <div class="exchange-title">Покупка золота за рубли</div>
                    <div class="exchange-rate">Курс: 10 золото = 1 рубль</div>
                    <form class="exchange-form" method="POST">
                        <input type="number" name="gold" min="1" 
                               placeholder="Количество золота" required>
                        <button type="submit" name="buy_gold">Купить</button>
                    </form>
                </div>
                
                <!-- Покупка кристаллов за рубли -->
                <div class="exchange-box">
                    <div class="exchange-title">Покупка кристаллов за рубли</div>
                    <div class="exchange-rate">Курс: 1 кристалл = 1 рубль</div>
                    <form class="exchange-form" method="POST">
                        <input type="number" name="crystals" min="1" 
                               placeholder="Количество кристаллов" required>
                        <button type="submit" name="buy_crystals">Купить</button>
                    </form>
                </div>
            </div>
